...
| Mark for completed | Marks a task in the list as completed. <br>> **Warning** `INDEX` must be positive and not exceed the size of the list. | `mark INDEX` <br>e.g., `mark 2` |

...
| Add Todo     | `todo return book`<br/> `td return book`                                                                                           |
| Add Deadline | `deadline DESCRIPTION /by YYYY-MM-DD HH:MM` <br/> `dl DESCRIPTION /by YYYY-MM-DD HH:MM`                                            |
| Add Event    | `event DESCRIPTION /from YYYY-MM-DD HH:MM /to YYYY-MM-DD HH:MM` <br/> `ev DESCRIPTION /from YYYY-MM-DD HH:MM /to YYYY-MM-DD HH:MM` |

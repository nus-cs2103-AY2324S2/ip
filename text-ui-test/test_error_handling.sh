...
java -classpath ../bin Main < ./in/error-01.txt  > ./out/error-01.txt
...
java -classpath ../bin Main < ./in/error-02.txt  > ./out/error-02.txt
...
java -classpath ../bin Main < ./in/error-03.txt  > ./out/error-03.txt

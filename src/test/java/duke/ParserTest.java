...
class ParserTest {
    ...
    public void parse_onlyCommandName_invalidCommandDataThrown() {
        Parser.InvalidCommandData thrown = Assertions.assertThrows(Parser.InvalidCommandData.class, () -> Parser.parse("event"));
    ...
    public void parse_noDescription_invalidCommandDataThrown() {
        Parser.InvalidCommandData thrown = Assertions.assertThrows(Parser.InvalidCommandData.class, () -> Parser.parse("deadline /by 12/12/2023 1200"));

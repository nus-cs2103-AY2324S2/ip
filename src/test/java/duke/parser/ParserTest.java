...
public class ParserTest {
    ...
    public void testMarkTaskAsDone() {
        ...
        parser.parseCommand("todo read book", ui, storage); // Add a task first
        String markInput = "mark 1";
        parser.parseCommand(markInput, ui, storage);
    ...
    public void testAddTodo() {
        ...
        parser.parseCommand(input, ui, storage);
    ...
    public void testEmptyTodo() {
        parser.parseCommand("todo", ui, storage);

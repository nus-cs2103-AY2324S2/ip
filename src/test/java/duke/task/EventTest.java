...
public class EventTest {
    ...
    public void event_constructor_success() throws Exception {
        ...
        LocalDateTime time1 = LocalDateTime.of(2024, 2, 3, 16, 00);
        LocalDateTime time2 = LocalDateTime.of(2024, 2, 3, 18, 00);
        String success = "[E] [ ] project meeting (" + returnFormat.format(time1) + " to " + returnFormat.format(time2) + ")";
        assertEquals(success, new Event("project meeting", "3/2/2024 1600", "3/2/2024 1800").toString());
    }

    @Test
    public void event_constructor_invalidDate_exceptionThrown() {

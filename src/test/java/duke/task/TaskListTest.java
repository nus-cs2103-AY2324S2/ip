...
//        // add a todo task
//        Task task = Task.createTask(TaskType.TODO, "test code");
//        taskList.add(task);
//        assertEquals(1, taskList.countTasks());
//
//        // add another deadline line
//        LocalDate date = LocalDate.of(2002, 2, 21);
//        Task task1 = Task.createTask(TaskType.DEADLINE, "test code", date);
//        taskList.add(task1);
...
//        Task task = Task.createTask(TaskType.TODO, "test");
//        taskList.add(task);
...
//        Task task = Task.createTask(TaskType.TODO, "test");
//        LocalDate date = LocalDate.of(2002, 2, 21);
//        Task task2 = Task.createTask(TaskType.DEADLINE, "test", date);
//
//        taskList.add(task);
//        taskList.add(task2);
//

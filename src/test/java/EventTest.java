...
public class EventTest {
    ...
    public void toString_eventObject_eventString() {
        assertEquals("[E][ ] test (from: Aug 21 2021 18:00 to: Aug 21 2021 19:00)", new Event("test", "2021-08-21 18:00", "2021-08-21 19:00").toString());
    }

    @Test
    public void toString_markedEventObject_markedEventString() {
        assertEquals("[E][X] test (from: Aug 21 2021 18:00 to: Aug 21 2021 19:00)", new Event("test", "2021-08-21 18:00", "2021-08-21 19:00", true).toString());
    }
    ...
    public void EventConstructor_timeNotSpecified_setToMidnight() {
        assertEquals(new Event("test", "2021-08-21 00:00", "2021-08-21 00:00").toString(), new Event("test", "2021-08-21", "2021-08-21").toString());
    }

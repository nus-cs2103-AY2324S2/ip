...
public class TaskTest {
    ...
    public void fromStorageString_noString_throws() {
        var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString(""));
    ...
    public void fromStorageString_noDelimString_throws() {
        var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("Tno delimitersF"));
        assertEquals("expected a name, but none was given", thrown.getMessage());
    }

    @Test
    public void fromStorageString_oneDelim_throws() {
        var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("T,one delimF"));
    ...
    public void fromStorageString_invalidTypeId_throws() {
        var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("???,one delim,F,L"));
        assertEquals("unexpected type string ???", thrown.getMessage());
    }

    @Test
    public void fromStorageString_invalidDoneString_throws() {
        var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("T,one delim,???,L"));
    ...
    class ToDo {
        ...
        @Test
        public void fromStorageString_todoStringHigh_success() throws LouieException {
            Task t = Task.fromStorageString("T,name,F,H");
            assertInstanceOf(louie.tasks.ToDo.class, t);
            assertEquals("[T][ ] \u2605 name", t.describe());
        }

        @Test
        public void fromStorageString_todoStringLow_success() throws LouieException {
        ...
        @Test
        public void fromStorageString_markedTodoString_success() throws LouieException {
        ...
        @Test
        public void fromStorageString_namelessTodoString_success() throws LouieException {
    ...
    class Deadline {
        ...
        @Test
        public void fromStorageString_deadlineString_success() throws LouieException {
            Task t = Task.fromStorageString("D,name,F,L,2024-06-06 0000");
            assertInstanceOf(louie.tasks.Deadline.class, t);
            assertEquals("[D][ ] name (by: 12:00 am, 6-06-2024)", t.describe());
        }

        @Test
        public void fromStorageString_markedDeadlineString_success() throws LouieException {
        ...
        public void fromStorageString_noDate_throws() {
            var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("D,name,F,L"));
    ...
    class Event {
        ...
        @Test
        public void fromStorageString_eventString_success() throws LouieException {
            Task t = Task.fromStorageString("E,name,F,L,2024-06-06 0000,2024-06-06 0100");
            assertInstanceOf(louie.tasks.Event.class, t);
            assertEquals("[E][ ] name (from: 12:00 am, 6-06-2024 to: 01:00 am, 6-06-2024)", t.describe());
        }

        @Test
        public void fromStorageString_markedEventString_success() throws LouieException {
        ...
        public void fromStorageString_noFrom_throws() {
            var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("E,name,F,L"));
            assertEquals("expected a start date, but none was given", thrown.getMessage());
        }

        @Test
        public void fromStorageString_noTo_throws() {
            var thrown = assertThrows(LouieException.class, () -> Task.fromStorageString("E,name,F,L,2024-06-06 0000"));

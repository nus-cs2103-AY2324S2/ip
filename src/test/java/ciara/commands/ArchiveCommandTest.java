...
/**
 * Test cases for methods in the ArchiveCommand Class
 *
 * @author RyanNgWH
 */
...
public class ArchiveCommandTest {
    ...
    public void createEnvironment() throws CiaraException {
        ...
        taskList.addTask(new Todo("buy lunch"), true);
    ...
    public void execute_archiveTask_success() throws CiaraException {
        ...
        ArchiveCommand archiveCommand = new ArchiveCommand(1, true);

        archiveCommand.execute(taskList, ui);
    ...
    public void execute_unarchiveTask_success() throws CiaraException {
        ...
        ArchiveCommand archiveCommand = new ArchiveCommand(0, false);

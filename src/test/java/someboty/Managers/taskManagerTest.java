...
public class taskManagerTest {
    ...
    public void ToDoTest() {
        ...
        String actual1 = manager.addTask('T', "Lord of the Bing Chillings");
        String expected1 = "[T][ ] Lord of the Bing Chillings";
        assertEquals(expected1, actual1);

        String actual2 = manager.addTask('T', "  With trail and lead spaces   ");
    ...
    public void DeadlineTest() {
        ...
        try {
            actual1 = manager.addTask('D', "1st Test /by 03-15-2024 0610");
        ...
        try {
            actual2 = manager.addTask('D', "2nd Test /by 15-03-2024");
        } catch (InputException e) {
        ...
        try {
            actual3 = manager.addTask('D', "Lord of the Bing Chillings /by12-12-2001");
        } catch (InputException e) {
    ...
    public void EventTest() {
        ...
        try {
            actual1 = manager.addTask('E', "1st Test /from 03-15-2024 0610 /to 16-10-2025 0950");
        } catch (InputException e) {
            actual1 = e.getMessage();
        }
        assertEquals(expected1, actual1);
        ...
        try {
            actual2 = manager.addTask('E', "2nd Test /to 12-13-2025 0950 /from 13-12-2024 0610");
        } catch (InputException e) {
            actual2 = e.getMessage();
        }
        assertEquals(expected2, actual2);
        ...
        try {
            actual3 = manager.addTask('E', "Lord of the Bing Chillings /from 12-12-2001");
        } catch (InputException e) {
            actual3 = e.getMessage();
        }
        assertEquals(expected3, actual3);

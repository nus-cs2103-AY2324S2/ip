...
public class ParserTest {
    ...
    public void testDeadlineInputs() {
        try {
            Command expected = new Deadline("test", LocalDateTime.of(2024, 1, 1, 18, 30));
        ...
        try {
            ...
            KleeException expected = new KleeException("The correct way to indicate a deadline is `deadline [description] /by [date and time]`");
            assertEquals(expected, actual);
        }
    ...
    @Test
    public void testEventInputs() {
        try {
            Command expected = new Event("test", LocalDateTime.of(2024, 1, 1, 18, 30), LocalDateTime.of(2024, 1, 31, 18, 30));
        ...
        try {
            ...
            KleeException expected = new KleeException("The correct way to indicate a event is `event [description] /from [date and time] /to [date and time]`");
            assertEquals(expected, actual);
        }
    ...
    public void testMarkInputs() {
        ...
        try {
            ...
            KleeException expected = new KleeException("There should be an integer after mark to indicate which task to mark!");
            assertEquals(expected, actual);
        }
    ...
    public void testUnMarkInputs() {
        ...
        try {
            ...
            KleeException expected = new KleeException("There should be an integer after unmark to indicate which task to unmark!");
            assertEquals(expected, actual);
        }
    ...
    public void testDeleteInputs() {
        ...
        try {
            ...
            KleeException expected = new KleeException("There should be an integer after delete to indicate which task to delete!");
            assertEquals(expected, actual);
        }

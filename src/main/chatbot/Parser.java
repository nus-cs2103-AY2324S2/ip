...
public class Parser {
    ...
    public String parseThrough(String io, String[] words, String detail, TaskList myList, Storage st) {
    try {
...
message.append("Now you have ").append(myList.len()).append(" tasks in the list.");  // Append the third line

...
public class CommandProcessor {
    ...
    public static void processTodoCommand(String input,TaskList tasks, Ui ui) {
        try {
            ...
            if (description.isEmpty()) {
                throw new RochinException("OOPS!!! The description of a todo task cannot be empty.");
            }
    ...
    public static void processDeadlineCommand(String input,TaskList tasks, Ui ui) {
        try {
            ...
            if (parts.length != 2) {
                throw new RochinException(
                        "Please provide both a description and a deadline for a deadline task. "
    ...
    public static void processEventCommand(String input,TaskList tasks, Ui ui) {
        try {
            ...
            if (parts.length != 2) {
                throw new RochinException(
                        "Please provide a description, start time, and end time for an event task. "
            ...
            if (dateTimeParts.length != 2) {
                throw new RochinException(
                        "Please provide both starting and ending date/time for the event. "
                        + "Example: event project meeting /from 2024-02-05 1200 /to 2024-02-05 1230");
            }

...
public class BobErrorMessages {
    ...
    public static final String INVALID_DATE_FORMAT = "Date specified is of the wrong format (expects dd/mm/yyyy i.e 01/01/1990).";
    public static final String INVALID_TIME_FORMAT = "Time specified is of the wrong format (expects 4 digit 24-hour format i.e 1800).";

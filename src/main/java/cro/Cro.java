 ...
 */
public class Cro extends Application {

    private Image user = new Image(this.getClass().getResourceAsStream("/images/UserImage.jpeg"));
    private Image cro = new Image(this.getClass().getResourceAsStream("/images/CroImage.jpeg"));
    ...
    public void start(Stage stage) {
        ui = new Ui(this);
        storage = new Storage("saveFile.txt");
        try {

...
public class MainWindow extends AnchorPane {
    ...
    private Alastor duke;

    private Image userImage = new Image(this.getClass().getResourceAsStream("/images/Charlie.png"));
    private Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/Alastor.png"));
    ...
    private void handleUserInput() {
        ...
        if (input.equals("bye")) {
            Timeline timeline = new Timeline(new KeyFrame(Duration.millis(3000), ae -> Platform.exit()));
            timeline.play();
        }
        userInput.clear();
    }

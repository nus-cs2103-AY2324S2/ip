...
public class Main extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/efren.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/ronnie.png"));

    private final Fireraya fireraya = new Fireraya("current_list.txt");
    ...
    private String getResponse(String input) {
        return fireraya.getResponse(input);
    }
}

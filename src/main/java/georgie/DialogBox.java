...
public class DialogBox extends HBox {
     ...
     * @param img  The image to be associated with the user dialog box.
    ...
    /**
     * Creates a Duke dialog box with the given text and image, and flips it to distinguish it as Duke's dialog.
     *

    ...
    public void processCommand(String userInput) {
        ...
        switch (sortTypeStr) {
            ...
            case "mark":
                ...
                break;
            default:
                System.out.println("Invalid sort type. Please enter one of 'alphabetical', 'start_date', 'end_date', 'task_type'.");
                return;
        }
       taskList.sortTaskList(sortType);

        System.out.println(chatbotUi.dividerWrapper("Here are the tasks sorted by " + sortTypeStr + ":\n" + taskList.showList()));
    }

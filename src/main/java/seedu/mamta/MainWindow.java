...
/**
 * Controller for MainWindow. Provides the layout for the other controls. Handles UI logic.
 */
public class MainWindow extends AnchorPane {
    ...
    private void handleUserInput() {
        ...
        String response = Parser.transformText(input);

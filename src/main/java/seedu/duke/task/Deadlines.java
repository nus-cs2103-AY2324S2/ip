...
/**
 * <h1> Deadlines </h1>
 * This Deadlines class is a subclass of the Task class, holding all the attributes and methods
 ...
 * Deadlines class objects have an attribute LocalDateTime deadline. This class handles all the functionalities
 * of a Deadlines object, such as the printing of the task description and the function that returns the data to be stored.
 *
...
public class Deadlines extends Task{
     ...
     * @return String parsed from the deadline attribute of this Deadlines object, representing

        ...
        while(!input.equals("bye")){
            ...
            try {
                ...
                case "list":
                    ...
                    break;
                case "mark":
                    Commands.commandMark(tempyArr, list);
                    break;
                case "unmark":
                    Commands.commandUnMark(tempyArr, list);
                    break;
                case "delete":
                    Commands.commandDelete(tempyArr, list);
                    break;
                case "todo":        
                    Commands.commandTodo(tempyArr, list);
                    break;
                case "deadline":    
                    Commands.commandDeadline(tempyArr, list);
                    break;
                case "event":
                    Commands.commandEvent(tempyArr, list);
                    break;    

...
public class TaskList {
    ...
    public String mark(int position) {
        ...
        if (position + 1 > taskList.size() || position < 0) {
            str = str + "buzz buzz~~ Task does not exist";
        } else {
    ...
    public String todo(Todo t) {
        taskList.add(t);
        String str = "buzz buzz~~ I've added this task:\n"
                + t.toString()
    ...
    public String delete(int position) {
        ...
        if (position + 1 > taskList.size() || position < 0) {
            ...
            Task t = taskList.get(position);
            taskList.remove(t);
            str = str + "buzz buzz~~ I've removed this task:\n"
                    + t.toString()
                    + "\nNow you have " + taskList.size() + " tasks in the list.";
        }
        return str;
    ...
    public String update(String newDescription, int position) {
        ...
        if (position + 1 > taskList.size() || position < 0) {
            ...
            str = str + "buzz buzz~~ I have updated the description\n"
                    + t.toString();
        }
        return str;
    }

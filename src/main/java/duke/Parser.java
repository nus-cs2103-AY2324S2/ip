...
public class Parser {
    ...
    /**
     *  Method that handles user input and returns an appropriate Command object to be executed in the main program.
     *
    ...
    public static Command handleInput(String input) {
        try {
            ...
            throw new IllegalArgumentException("Blunder! Declare yer dates as dd/MM/yyyy HHmm, ye scurvy dog!");
        }
    }

...
public class Parser {
    ...
    public String[] decryptInput(String echo) throws DukeException {
        ...
        if (isDeadline) {
            deadlineParse(results, echo);
        } else if (isEvent) {
            eventParse(results, echo);
        } else if (isTodo) {
            todoParse(results, echo);
        } else {
    ...
    /**
     * Parses a deadline based on the input of the user into relevant details needed later
     * for forming Tasks
     *
     * @param results string array to put results of parsing in
     * @param echo input to be analysed
     * @throws DukeException if input cannot be decrypted properly meaning invalid input
     */
    private void deadlineParse(String[] results, String echo) throws DukeException {
    ...
    /**
     * Parses an event based on the input of the user into relevant details needed later
     * for forming Tasks
     *
     * @param results string array to put results of parsing in
     * @param echo input to be analysed
     * @throws DukeException if input cannot be decrypted properly meaning invalid input
     */
    private void eventParse(String[] results, String echo) throws DukeException {
    ...
    /**
     * Parses a todo based on the input of the user into relevant details needed later
     * for forming Tasks
     *
     * @param results string array to put results of parsing in
     * @param echo input to be analysed
     * @throws DukeException if input cannot be decrypted properly meaning invalid input
     */
    private void todoParse(String[] results, String echo) throws DukeException {

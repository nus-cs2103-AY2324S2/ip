 ...
 * A "todo" task is a basic task type that consists of a description and a completion status but does not have an associated time.
 */
public class Todo extends Task {
     ...
     *
     * @return A string formatted for saving the todo task to a file, including its type, completion status, and description.
     */
    @Override
     ...
     * This representation includes the task type indicator ('[T]'), the completion status (marked as '[X]' for done and '[ ]' for not done),
     * and the task description.
     *
     * @return A string representation of the todo task, including its type, completion status, and description, suitable for display.
     */
    @Override

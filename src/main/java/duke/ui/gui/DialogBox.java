...
import duke.exceptions.resource.LoadResourceFailedException;
...
public class DialogBox extends HBox {
     ...
     */
    private DialogBox(String text, Image image) throws DukeException {
        try {
    ...
    /**
     * Creates a dialog box representing a Duke's message.

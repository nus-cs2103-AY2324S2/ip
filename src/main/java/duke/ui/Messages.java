...
public enum Messages {
    EXIT("Aw, see you soon! :3\n"),
    INDEX_ERROR("I can't do that.. Task index %s is out of range! ~(T_T)\n"),

    DELETE_ERROR("Hey, you need to tell me which one to delete! Try 'delete <INDEX>'. ~(>_<)\n"),

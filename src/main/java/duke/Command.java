...
public abstract class Command {
     ...
     *
     * @param taskList   The task list on which the command will operate, allowing commands to modify or query the task list.
     * @param ui         The user interface for displaying messages to the user, enabling interaction and feedback.
     * @param userInput  The user input specifying the command and its arguments, which determines the actions to be performed.
     * @throws DukeException If there is an issue executing the command or if the command encounters an error, providing error handling.
     */

...
public class CommandList {
     ...
     *
     * @throws LouieCommandNotFoundException if there is nothing found.
     */
    public Command get(String cmdName) throws LouieCommandNotFoundException {
        switch (cmdName) {
        case "list":
        ...
        default:
            throw new LouieCommandNotFoundException();
        }
    }

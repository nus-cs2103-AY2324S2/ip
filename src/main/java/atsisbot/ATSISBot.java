...
/**
 * The atsisbot.AtsisBot class represents a chatbot that can perform various tasks. It allows users
 * to interact with the bot by entering commands and receiving responses. The bot can manage a list
...
public class AtsisBot {
    ...
    /**
     * The main method is the entry point of the atsisbot.AtsisBot program. It prompts the user for
     * input and executes corresponding commands based on the input. The program continues to accept

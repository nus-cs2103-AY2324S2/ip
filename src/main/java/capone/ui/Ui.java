...
public class Ui {
    ...
    public String sendHelp() {
        String output = "Commands I understand:\n"
                ...
                + "3. deadline [description] /by [date] [time] - Creates a new capone.tasks.Deadline task.\n"
                + "   Remember to enter the description and date!\n"
                + "   Dates are recognised in the following format - 'yyyy-mm-dd HHmm' (24-hour).\n"
                + "4. event [description] /from [date] [time] /to [date] [time] - Creates a new capone.tasks.Event task.\n"

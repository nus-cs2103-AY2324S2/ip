...
public class MainWindow extends AnchorPane {
    ...
    public void initialize() {
        ...
        dialogContainer.getChildren().add(DialogBox.getVenusDialog(Gui.getStart(), venusImage));
    }

    public void setVenus(Venus v) {
        venus = v;
    }
    ...
    private void handleUserInput() {
        ...
        String response = venus.getResponse(input);
        dialogContainer.getChildren().addAll(
                DialogBox.getUserDialog(input, userImage),
                DialogBox.getVenusDialog(response, venusImage)
        );
        userInput.clear();
    }
}
